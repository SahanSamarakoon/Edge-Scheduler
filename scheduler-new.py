...
class CustomScheduler(object):
    ...
    def __init__(self, scheduler_name="custom-scheduler"):
        ...
        self.latency_matrix = {iotservice1:{edge1:10, edge2:20, edge3: 15}, iotservice2:{edge1:10, edge2:20, edge3: 15}}
    ...
    def get_nodes_in_radius(self, required_delay, iot_device_servicename):
    ...
    def schedule(self, pod, namespace="default"):
        try:
            ...
            if any_assigned_placeholder:
                ...
                all_nodes_in_radius = self.get_nodes_in_radius(required_delay, iot_device_servicename)
                ...
                if 'edge-1' in [x.metadata.name for x in nodes_enough_resource_in_rad]:
                    node = next(x for x in nodes_enough_resource_in_rad if x.metadata.name == 'edge-1')
                else:
